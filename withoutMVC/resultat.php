    ...
    public function rechercher()
    {
        ...
        if (isset($_POST['checkboxGrouper'])) {
            ...
            try {
                ...
                echo "<div style='height: 50px' class='bg-dark'><h3 class='text-light bg-dark' style='margin-left: 10px; padding-top: 5px'>Publications et références disponibles en archives ouvertes: <a href='index.html'><button type='button' class='btn btn-dark float-right'>Retour</button></a></h3></div>";
                ...
                if ($json !== null) {
                    ...
                    if (count($tabResults) > 0) {
                        ...
                        foreach ($tabResults as $key => $element) {
                            ?>
                            <div style="margin-bottom: 15px; background-color: #D3D3D3; border-radius: 20px; padding-top: 10px; margin-top: 20px">
