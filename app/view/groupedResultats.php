...
/**
 * Boucle qui permet de trier les publications par Type de Document
 */


/**
 * Boucle qui permet d'afficher toutes les publications d'un Type, suivant le nom du professeur donné
